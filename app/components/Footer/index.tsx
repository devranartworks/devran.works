        ...
        <footer className="flex w-full justify-center">
            <div className="w-full max-w-[1120px] px-5 py-8">
                <div className="flex items-center justify-between gap-16">
                    <p className="font-medium text-stone-500">Tasarım ve Geliştirme <b className="font-semibold">Yılmaz Ev</b> <span className="mx-1 font-apple-color-emoji text-lg">🤌🏻</span> 2023</p>
